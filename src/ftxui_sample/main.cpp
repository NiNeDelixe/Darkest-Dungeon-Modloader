...
// configuration step. It creates a namespace called `Darkest_Dungeon_Modloader`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Darkest_Dungeon_Modloader::cmake::project_name, Darkest_Dungeon_Modloader::cmake::project_version) };
